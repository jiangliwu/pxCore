"use strict";
/**
 * dukluv basic class wrapper
 * all binding from dukluv,libuv,duktape
 */
...
Handle.prototype.socketClose = function close(callback) {
  return uv.close(this.handle, callback);
};

/**
 * basic stream class wrapper
 */
 ...
 * @param isSecurity is need ssl support or not
 * @constructor
 */
function Tcp(isSecurity) {
  this.handle = uv.new_tcp.call(this, isSecurity);
}
